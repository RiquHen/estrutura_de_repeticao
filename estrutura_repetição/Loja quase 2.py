...
ele desenvolveu um tabela que contém o número de itens que o cliente comprou
e ao lado o valor da conta. Desta forma a atendente do caixa precisa apenas
...
50 - R$ 99.50"""
print(40*"=")
print(f"{'Loja Quase Dois - Tabela de Preços':^40}\n{40*'='}")
unidade = 1.99
for i in range(50):
    print(f"{i+1} - R$ {unidade * (i+1):.2f}", end='\t')